...
const hero = () => {
  let tag = "Supporting city skin",
    ...
    content = `This antioxidant moisturizing essence is specially developed for urbanites. It can effectively moisturize, moisturize and support skin health through a variety of carefully selected high-efficiency ingredients.`,
    btnText = "Explore Product recipees",
    color = "primary";
  return (
